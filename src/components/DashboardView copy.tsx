                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="flex gap-1">
                          ...
                          <button className="p-1.5 hover:bg-gray-100 dark:hover:bg-[#28243a] rounded transition-colors" title="Edit">
                            <Edit className="w-4 h-4 text-gray-500 dark:text-[#8a7fa3]" />
                          </button>
                          <button className="p-1.5 hover:bg-red-50 dark:hover:bg-[#3a2538] rounded transition-colors" title="Delete">
                            <Trash2 className="w-4 h-4 text-red-500" />
                          </button>
                        </div>
                      </div>
                      <p className="text-sm text-gray-900 dark:text-[#b8aaff] leading-relaxed mb-3">{post.content}</p>
                      <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-[#2a2538]">
                        <span className="text-xs text-gray-500 dark:text-[#8a7fa3]">
                          {new Date(post.created_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                        </span>
                        {post.status === 'draft' && (
                          <button className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-primary-600 to-primary-700 dark:from-[#7b6cff] dark:to-[#6b5cef] text-white text-xs font-medium rounded-lg hover:from-primary-700 hover:to-primary-800 dark:hover:from-[#8b7cff] dark:hover:to-[#7b6cff] transition-all duration-300">
